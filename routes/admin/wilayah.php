...
Route::group(['middleware' => ['role:admin|gereja|wilayah']], function () {
    ...
    Route::controller(WilayahController::class)->group(function(){
        ...
        Route::get('wilayah/tambah', [WilayahController::class, 'create'])->name('wilayah.tambah')->middleware(['role:admin|wilayah']);
        Route::get('wilayah/detail/{id}', [WilayahController::class, 'show'])->name('wilayah.detail');
        Route::delete('wilayah/{id}', [WilayahController::class, 'destroy'])->name('wilayah.hapus')->middleware(['role:admin|wilayah']);
        Route::post('wilayah/store', [WilayahController::class, 'store'])->name('wilayah.store')->middleware(['role:admin|wilayah']);
